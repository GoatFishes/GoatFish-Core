...
describe('Bots API', () => {
    ...
    describe('orders', () => {
        describe('/get with "Filled" for a single order status', async () => {
            var res
            before(async () => {
                let topic = "orders"
                await insertBotStrategy(["defaultKeys", "", 0.0, 0.0, 3009, null, 'Stop'])
        ...
        describe('/get for several orders with "Open" order status', async () => {
            var res
            before(async () => {
                let topic = "orders"
                await insertBotStrategy(["defaultKeys", "", 0.0, 0.0, 3009, null, 'Stop'])
                payloads = [
                    { topic: topic, messages: '{"bot_id":"defaultKeys","exchange":"bitmex","data":[{"orderID":"ab7ae2nf-c828-76fc-3190-a35883804599","clOrdID":"","clOrdLinkID":"","account":1180512,"symbol":"XBTUSD","side":"Sell","simpleOrderQty":null,"orderQty":100,"price":11948,"displayQty":null,"stopPx":null,"pegOffsetValue":null,"pegPriceType":"","currency":"USD","settlCurrency":"XBt","ordType":"Limit","timeInForce":"GoodTillCancel","execInst":"","contingencyType":"","exDestination":"XBME","ordStatus":"Open","triggered":"","workingIndicator":false,"ordRejReason":"","simpleLeavesQty":null,"leavesQty":0,"simpleCumQty":null,"cumQty":100,"avgPx":11949,"multiLegReportingType":"SingleSecurity","text":"Submission from www.bitmex.com","transactTime":"2019-08-08T01:04:28.939Z","timestamp":"2019-08-08T01:04:28.939Z"}]}', partition: 0 }
                ]
                await producer.send(payloads, async function (err, data) {
                })

                await insertOrder(["defaultKeys", "bitmex", "ab7ae2nf-c828-76fc-3190-a35883804599", null, "2019-08-08T01:04:28.939Z", "Open", "Buy", 1000, 8000, 4000, 10, "Limit", null])
                await insertOrder(["defaultKeys", "bitmex", "ab7ae2nf-c828-76fc-3190-a358838045e9", null, "2019-08-08T01:04:28.989Z", "Open", "Buy", 1000, 8000, 4000, 10, "Limit", null])
                await insertOrder(["defaultKeys", "bitmex", "ab7ae2nf-c828-76fc-3190-a35883804589", null, "2019-08-08T01:04:28.989Z", "Open", "Buy", 1000, 8000, 4000, 10, "Limit", null])
    ...
    describe('positions', () => {
        describe('Should succesfully call the / endpoint with type = null', async () => {
            var res
            ...
            before(async () => {
                ...
                await insertOrder(["defaultKeys", "bitmex", "ab7ae2nf-c828-76fc-3190-a35883804599", null, "2019-08-08T01:04:28.939Z", "Filled", "Sell", 1000, 8000, 4000, 10, "Limit", 200])
                await insertOrder(["defaultKeys", "bitmex", "ab7ae2nf-c824-76fc-3190-a35883804599", null, "2019-08-08T01:04:29.939Z", "Filled", "Buy", 1000, 8000, 4000, 10, "Limit", 200])

                await insertOrder(["defaultKeys", "bitmex", "ab7ae2nf-c824-76fc-3190-a35883804599", null, "2019-08-08T01:04:29.939Z", "Filled", "Buy", 1000, 8000, 4000, 10, "Limit", 200])
                await insertOrder(["defaultKeys", "bitmex", "ab7ae2nf-c828-76fc-3190-a35883804599", null, "2019-08-08T01:04:28.939Z", "Filled", "Buy", 1000, 8000, 4000, 10, "Limit", 200])
                await insertOrder(["defaultKeys", "bitmex", "ab7ae2nf-c824-76fc-3190-a35883804599", null, "2019-08-08T01:04:29.939Z", "Filled", "Sell", 2000, 8000, 8000, 10, "Limit", 200])

                await insertOrder(["defaultKeys", "bitmex", "ab7ae2nf-c824-76fc-3190-a35883804599", null, "2019-08-08T01:04:29.939Z", "Filled", "Sell", 1000, 8000, 4000, 10, "Limit", 200])
                await insertOrder(["defaultKeys", "bitmex", "ab7ae2nf-c824-76fc-3190-a35883804599", null, "2019-08-08T01:04:29.939Z", "Filled", "Sell", 1000, 8000, 4000, 10, "Limit", 200])
                await insertOrder(["defaultKeys", "bitmex", "ab7ae2nf-c824-76fc-3190-a35883804599", null, "2019-08-08T01:04:29.939Z", "Filled", "Buy", 2000, 8000, 8000, 10, "Limit", 200])
        ...
        describe('Should succesfully call the / endpoint with type = paperTrade', async () => {
            before(async () => {
                await insertPaperOrder(["defaultKeys", "bitmex", "ab7ae2nf-c828-76fc-3190-a35883804599", null, "2019-08-08T01:04:28.939Z", "Filled", "Sell", 1000, 8000, 4000, 10, "Limit", 200])
                await insertPaperOrder(["defaultKeys", "bitmex", "ab7ae2nf-c824-76fc-3190-a35883804599", null, "2019-08-08T01:04:29.939Z", "Filled", "Buy", 1000, 8000, 4000, 10, "Limit", 200])
                res = await chai
                    .request(server)
